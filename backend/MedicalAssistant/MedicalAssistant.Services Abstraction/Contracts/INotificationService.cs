...
public interface INotificationService
{
    ...
    Task NotifyDoctorNewAppointment(int appointmentId, string doctorEmail, string patientName, string scheduledAt);
    ...
    Task NotifyDoctorAppointmentChanged(int appointmentId, string doctorEmail, string status, string patientName);
}
