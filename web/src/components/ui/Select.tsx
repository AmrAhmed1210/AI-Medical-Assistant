...
export const Select = ({ className = '', error, children, ...props }: SelectProps) => (
  <div className="relative">
    <select
      className={`w-full px-4 py-3 text-sm border rounded-2xl focus:outline-none focus:ring-4 transition-all duration-200 appearance-none bg-white text-gray-900 shadow-sm ${
        error 
